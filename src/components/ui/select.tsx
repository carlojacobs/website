    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          <span className="relative block h-full rounded-lg border border-black/10 bg-[#f8f7f4] bg-clip-padding before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-lg dark:not-in-data-[slot=group]:bg-clip-border">
